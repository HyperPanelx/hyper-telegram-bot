...
const add_card_info=require('./actions/add_card_info')
const show_waiting_payment=require('./actions/show_waiting_payment')
const renew=require('./actions/renew_user')
